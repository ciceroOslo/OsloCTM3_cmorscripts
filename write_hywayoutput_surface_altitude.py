...
def read_avgsav_onemonth(filepath, year,year_out,variables):
    ...
    variable_list = ['lat','lon','lev','ihya','ihyb'] +  variables
...
long_name_dict = {'orog':'surface_altitude'}


complist_ctm_dict = {'orog': 'height'}
...
for m,metyear in enumerate(metyear_list):
    ...
    for comp in complist_ctm_dict:
        ...
        data_field[comp] = data_field[variables].isel(ilev=0)
